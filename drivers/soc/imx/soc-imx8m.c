...
static void print_board_info (void)
{
	...
	{
		printk ("\tBSP Version            : iW-PRFYZ-SC-01-R1.0-REL1.0a-Linux5.15.32\n");
	...
	{
		printk ("\tBSP Version            : iW-PRGJZ-SC-01-R1.0-REL1.0a-Linux5.15.32\n");
	...
	{
		printk ("\tBSP Version            : iW-PRGII-SC-01-R1.0-REL1.0a-Linux5.15.32\n");
	...
	{
		printk ("\tBSP Version            : iW-PRGNZ-SC-01-R3.0-REL1.0a-Linux5.15.32\n");
