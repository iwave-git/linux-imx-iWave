...
static void lt8912_init(struct lt8912 *lt)
{
	...
	regmap_write(lt->regmap[1],0x18,0x80);
	regmap_write(lt->regmap[1],0x19,0x02);
	regmap_write(lt->regmap[1],0x1c,0x20);
	regmap_write(lt->regmap[1],0x1d,0x03);
	regmap_write(lt->regmap[1],0x2f,0x0c);
	regmap_write(lt->regmap[1],0x34,0x20);
	regmap_write(lt->regmap[1],0x35,0x04);
	regmap_write(lt->regmap[1],0x36,0x0d);
	regmap_write(lt->regmap[1],0x37,0x02);
	regmap_write(lt->regmap[1],0x38,0x21);
	regmap_write(lt->regmap[1],0x39,0x00);
	regmap_write(lt->regmap[1],0x3a,0x0a);
	regmap_write(lt->regmap[1],0x3b,0x00);
	regmap_write(lt->regmap[1],0x3c,0x58);
	regmap_write(lt->regmap[1],0x3d,0x00);
	regmap_write(lt->regmap[1],0x3e,0x28);
	regmap_write(lt->regmap[1],0x3f,0x00);

	regmap_write(lt->regmap[0],0x9c,0x73);
	regmap_write(lt->regmap[0],0x9d,0x45);
	regmap_write(lt->regmap[0],0x9e,0xee);
	regmap_write(lt->regmap[0],0x9f,0x02);
...
{
	regmap_write(lt->regmap[0], 0x02,0x00); /* LVDS Softreset */
	msleep(5);
	backlight_disable(lt->backlight);
}
...
lt8912_connector_detect(struct drm_connector *connector, bool force)
{
	...
	if(lt->connector_type == DRM_MODE_CONNECTOR_LVDS)
...
static void lt8912_bridge_post_disable(struct drm_bridge *bridge)
{
	...
	if(lt->connector_type == DRM_MODE_CONNECTOR_LVDS)
		regmap_write(lt->regmap[0], 0x02,0x00);
}
...
static void lt8912_bridge_enable(struct drm_bridge *bridge)
{
	...
	if(lt->connector_type == DRM_MODE_CONNECTOR_HDMIA)
		lt8912_init_hdmi(lt);
	else
		lt8912_init(lt);
}
...
void lt8912_rgb_detach_dsi(struct lt8912 *lt)
{
	mipi_dsi_detach(lt->dsi);
	mipi_dsi_device_unregister(lt->dsi);
}

int lt8912_rgb_hdmi_hw_params(struct device *dev, void *data,
...
static const struct hdmi_codec_ops lt8912_codec_ops = {
	.hw_params      = lt8912_rgb_hdmi_hw_params,
	.audio_shutdown = audio_shutdown,
	.audio_startup  = audio_startup,
	.get_dai_id     = lt8912_hdmi_i2s_get_dai_id,
};

int lt8912_rgb_audio_init(struct device *dev, struct lt8912 *lt8912)
{
...
void lt8912_rgb_audio_exit(struct lt8912 *lt8912)
{
...
static int lt8912_rgb_probe(struct i2c_client *i2c, const struct i2c_device_id *id)
{
	...
	return lt8912_rgb_audio_init(dev,lt);
